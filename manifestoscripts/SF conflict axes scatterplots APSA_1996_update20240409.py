...
f.legend(custom, ["SP", "Agalev", "VLD", "CVP", "Volksunie", "Vlaams Belang",
...
opposing_partiesBE = {"Belgium": ["Agalev", "Volksunie"]}
...
plt.savefig(os.path.join(path,'conflict_axis_customscatter_199x.jpg'),dpi=1200)
plt.show()
