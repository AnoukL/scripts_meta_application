...
regression_goal = "SF_fixed-party_l-r"
...
for frame in total_frames:
	...
	plt.savefig(os.path.join(var.output_path,
						  f'confidenceplot_{frame}_{vote_treshold}_{plotted_value}.png'),
			 bbox_inches='tight')

analysis_data.to_excel(os.path.join(var.output_path, "modelanalysis_data.xlsx"),
					   index=False)
